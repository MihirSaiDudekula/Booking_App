...
// Functional component 'PlaceGallery' that takes 'place' as props
// sent from PlacePage
export default function PlaceGallery({ place }) {
  // State variable 'showAllPhotos' and its setter function 'setShowAllPhotos' initialized using the 'useState' hook

  //if showAllPhotos is false, we will show only few photos, the 
  const [showAllPhotos, setShowAllPhotos] = useState(false);

  // If 'showAllPhotos' state is true, display all photos in a modal
  if (showAllPhotos) {
    return (
      <div className="absolute inset-0 bg-black text-white min-h-screen">
        <div className="bg-black p-8 grid gap-4">
          ...
          {/* Map through 'place.photos' array and display each photo using 'Image' component */}
  ...
  // If 'showAllPhotos' state is false, display only the first three photos in a grid
  return (
    <div className="relative">
      ...
      {/* Button to show more photos, clicking on it sets 'showAllPhotos' state to true */}
