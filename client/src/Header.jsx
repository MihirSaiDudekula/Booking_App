...
import { UserContext } from './UserContext'; // Import UserContext to access user-related context
  ...
  return (
    <header className="flex justify-between items-center p-4 border-b border-gray-300">
      ...
      <div className="flex gap-2 items-center">
        ...
        <Link to="/login" className="border rounded-full p-2 hover:bg-gray-200">
